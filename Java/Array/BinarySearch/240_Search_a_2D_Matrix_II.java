...
// http://articles.leetcode.com/2010/10/searching-2d-sorted-matrix.html
...
public class Solution {
    public boolean searchMatrix(int[][] matrix, int target) {
        ...
        // Step-wise Linear Search: O(n) time
        // Choose a place to start from: try the top right corner. 
